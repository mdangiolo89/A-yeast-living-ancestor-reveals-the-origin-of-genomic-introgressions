...
samtools depth -ab CBS432.markers.bed ${sample}_${ref}_${run}.dedup.bam > ${sample}_${ref}_${run}.dedup.bam.dat
...
for chr in $chrlist
do 
perl genotypeassignerScer.pl ${sample}_${ref}_${run}.dedup.bam.dat ${sample}_${ref}_${run}.FreeBayes.snps.Q20.${chr}.vcf.recode.vcf DBVPG6765_CBS432_LOHmarkers.txt
done 

## annotate homozygous (C.annotation) and heterozygous (H.annotation) LOH/introgression blocks in bed format
for chr in $chrlist
do
perl annotatorD.pl ${sample}_${ref}_${run}.FreeBayes.snps.Q20.${chr}.vcf.recode.vcf.genotype
